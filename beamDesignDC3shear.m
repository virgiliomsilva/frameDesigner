function [shearReinfPhi, shearReinfSpac, shearReinfLoops, shearReinfArea] = beamDesignDC3shear(fck, fyk , cover, Fz_Ed, b_input, h_input, longPhi)
...
DC3_Spacing = min([(h - 2 * cover - shearReinfPhi/1000)/2, .175, 8 * longPhi/1000]);
