function [sec_h, sec_b, longReinfNo, longReinfPhi, longReinfArea, M_Rd, shearReinfPhi, shearReinfSpac, shearReinfLoops, V_Rd] = beamDesignDC1(fck, fyk , cover, M_Ed, Fz_Ed)
