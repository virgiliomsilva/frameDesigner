function [shearReinfPhi, shearReinfSpac, shearReinfLoops, V_Rd] = DC2beamDesignMidShear(fck, fyk , cover, Fz_Ed, sec_b, sec_h, longReinfNo)
...
% if exist('given_b', 'var'); sec_b = sec_b; end
%     if exist('given_h', 'var'); sec_h = sec_h; end
