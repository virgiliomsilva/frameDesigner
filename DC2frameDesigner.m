%% DC2frameDesigner
function [] = DC2frameDesigner(buildingName, fck, fyk, cover, seismicCases, folder)
...
save([folder '\DC2columnsIt2rule13.mat'],'columns13')
%% seismic equilibrium
%beam
...
save([folder '\DC2columnsIt3SeismicEq.mat'],'seismicColumns')
%%
